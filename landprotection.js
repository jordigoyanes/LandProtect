...
if(alldata === undefined){ alldata = {}; alldata.chunks= {};}

function claimSign(event){
	var player = event.getPlayer();
	var balance = player.getScoreboard().getObjective(org.bukkit.scoreboard.DisplaySlot.SIDEBAR).getScore(player).getScore()
